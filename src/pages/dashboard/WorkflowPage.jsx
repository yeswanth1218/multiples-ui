        ...
        <div className="h-full flex flex-col animate-in fade-in duration-500">
            ...
            <div className="flex-1 overflow-x-auto pb-4">
                <div className="flex gap-6 min-w-[1000px] h-full">
                    {columns.map((col, i) => (
                        <div key={i} className="flex-1 min-w-[280px] flex flex-col bg-gray-50/80 dark:bg-gradient-to-b dark:from-[#1a1a1a]/80 dark:to-[#0f0f0f]/80 rounded-xl p-4 border border-gray-200/50 dark:border-white/5 ring-1 ring-gray-100 dark:ring-white/5">
                            ...
                            <div className="space-y-3 overflow-y-auto pr-1">
                                ...
                                {/* Dummy tasks to fill columns visually */}
                                {i === 1 && <div className="bg-gradient-to-b from-gray-100/80 to-white dark:from-[#1a1a1a] dark:to-[#0f0f0f] p-4 rounded-lg border border-gray-200/60 dark:border-white/10 shadow-[0_1px_3px_rgba(0,0,0,0.05),0_4px_12px_rgba(0,0,0,0.08)] dark:shadow-[0_1px_3px_rgba(0,0,0,0.3),0_4px_12px_rgba(0,0,0,0.4)] h-24 opacity-50"></div>}
                                {i === 3 && <div className="bg-gradient-to-b from-gray-100/80 to-white dark:from-[#1a1a1a] dark:to-[#0f0f0f] p-4 rounded-lg border border-gray-200/60 dark:border-white/10 shadow-[0_1px_3px_rgba(0,0,0,0.05),0_4px_12px_rgba(0,0,0,0.08)] dark:shadow-[0_1px_3px_rgba(0,0,0,0.3),0_4px_12px_rgba(0,0,0,0.4)] h-24 opacity-50"></div>}
                            </div>
                            <button className="mt-3 w-full py-2 flex items-center justify-center gap-2 text-gray-400 hover:bg-gray-200 dark:hover:bg-[#27272a] rounded-lg transition-colors text-sm font-medium border border-dashed border-gray-300 dark:border-[#3f3f46]">
